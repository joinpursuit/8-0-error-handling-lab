...
function filterProductsByPriceRange(products, min, max) {
  if (products.length === 0 || typeof max !== "number" || min <=0 || min > max || typeof min !== "number" || max <= 0 || !products.every((product) => product.hasOwnProperty("priceInCents")))
    throw "error"
